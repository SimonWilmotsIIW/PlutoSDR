...
class pluto_testing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "pluto_testing")
        ...
        self.hyperfine_freq = hyperfine_freq = 2160000
    ...
    def get_hyperfine_freq(self):
        return self.hyperfine_freq

    def set_hyperfine_freq(self, hyperfine_freq):
        self.hyperfine_freq = hyperfine_freq
...
def main(top_block_cls=pluto_testing, options=None):
