...
class pluto_sink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "pluto_sink")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 2400000000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_waterfall_sink_x_0, 1))
...
def main(top_block_cls=pluto_sink, options=None):
