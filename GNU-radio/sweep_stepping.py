...
import sip
import sweep_stepping_python_mod as python_mod  # embedded python module
import threading
import time



class sweep_stepping(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sweep_stepping")
        ...
        self.current_freq = current_freq = python_mod.sweeper(fun_prob)
        self.variable_qtgui_label_0 = variable_qtgui_label_0 = fun_prob
        self.samp_rate = samp_rate = 500e6
        self.frequency = frequency = current_freq
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, current_freq, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, 0, 1, 0, 0)
    ...
    def set_fun_prob(self, fun_prob):
        ...
        self.set_current_freq(python_mod.sweeper(self.fun_prob))
        self.set_variable_qtgui_label_0(self.fun_prob)
    ...
    def set_current_freq(self, current_freq):
        ...
        self.analog_sig_source_x_0_0.set_frequency(self.current_freq)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range((self.LO_freq + self.freq_dev), self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range((self.LO_freq + self.freq_dev), self.samp_rate)
...
def main(top_block_cls=sweep_stepping, options=None):
